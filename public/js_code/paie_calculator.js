...
var valeur_repas = document.getElementById("valeur_repas");
var valeur_transport = document.getElementById("valeur_transport");
	...
	function uploadFile(file) {
		...
		if (xhr.upload) {
			...
			if (file.size <= fileSizeLimit * 1024 * 1024) {
				...
				filedata.append("sme", sme.value);
				filedata.append("repas", valeur_repas.value);
				filedata.append("transport", valeur_transport.value);
